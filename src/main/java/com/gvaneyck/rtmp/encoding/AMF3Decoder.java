...
public class AMF3Decoder {
     ...
     */
    public TypedObject decodeConnect(byte[] data) throws IOException {
        reset();
     ...
     * @return The decoded object
     */
    public TypedObject decodeInvoke(byte[] data) throws IOException {
        reset();
        ...
        if (inline) {
            ...
            if (cd.externalizable) {
                if (cd.type.equals("DSK"))
                    ...
                    ret = new TypedObject(objectMapper.readValue(json, Map.class));
                    ret.type = cd.type;
                }
                else {
     ...
     */
    private TypedObject readDSA() throws IOException {
     ...
     */
    private TypedObject readDSK() throws IOException {
    ...
    private void readRemaining(int flag, int bits) throws IOException {
     ...
     * @return The decoded object
     */
    private TypedObject readObjectAMF0() throws IOException {
